...
import { ArrowBackIcon, RepeatIcon } from "@chakra-ui/icons"; // Refresh icon added
...
const ENDPOINT = "https://localhost:5000/"; // Update to match the actual backend URL
          ...
          >
            ...
            {messages && !selectedChat.isGroupChat ? (
              <>
                ...
                <IconButton
                  icon={<RepeatIcon />} // Refresh button
                  onClick={fetchMessages} // Refresh messages
                  ml={2}
                />
              </>
            ) : (
